...
<head>
    ...
    <title>Klinik Sehat — Klinik Umum & Spesialis</title>
    <meta name="description" content="Klinik Sehat melayani pemeriksaan umum, gigi, dan laboratorium di Jl. Sudirman No. 45, Jakarta Selatan. Buka Senin–Sabtu.">
    ...
    <nav class="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div class="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
            <a href="" class="flex items-center gap-2">
                ...
                <span class="text-lg font-bold text-gray-900">Klinik Sehat</span>
            </a>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('register') }}" class="text-sm font-semibold bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg">Daftar Pasien</a>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-6xl mx-auto px-6 py-20 md:py-28 grid md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="{{ route('register') }}" class="bg-white text-blue-700 font-bold px-6 py-3 rounded-lg text-sm hover:bg-blue-50">
                        Daftar Pemeriksaan Online
                    </a>
                    <a href="https://wa.me/6281234567890" target="_blank" class="border border-white/40 text-white font-semibold px-6 py-3 rounded-lg text-sm hover:bg-white/10">
                        Hubungi via WhatsApp
                    </a>
                </div>
            </div>
            <div class="hidden md:block">
                <img src="https://images.unsplash.com/photo-1551190822-a9333d879b1f?auto=format&fit=crop&w=600&q=80" alt="Dokter melayani pasien" class="rounded-2xl shadow-2xl w-full object-cover h-80">
            </div>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <div class="service-card bg-white border border-gray-100 rounded-xl p-6">
                <div class="w-11 h-11 bg-blue-50 rounded-lg flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>
                </div>
                <h3 class="font-bold text-gray-900 mb-2">Pemeriksaan Umum</h3>
                <p class="text-sm text-gray-500 leading-relaxed">Konsultasi keluhan kesehatan sehari-hari, cek tekanan darah, demam, batuk, flu, dan penanganan medis ringan lainnya.</p>
            ...
            <div class="service-card bg-white border border-gray-100 rounded-xl p-6">
                ...
                <p class="text-sm text-gray-500 leading-relaxed">Perawatan gigi mulai dari pembersihan karang gigi, tambal gigi, cabut gigi, hingga konsultasi ortodonti dasar.</p>
            ...
            <div class="service-card bg-white border border-gray-100 rounded-xl p-6">
                ...
                <p class="text-sm text-gray-500 leading-relaxed">Pemeriksaan darah lengkap, cek gula darah, kolesterol, asam urat, tes urine, dan paket medical check-up tahunan.</p>
            ...
            <div class="bg-white rounded-xl border border-gray-100 overflow-hidden">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr>
                            <td class="px-6 py-3 font-medium text-gray-900">dr. Andi Pratama, Sp.PD</td>
                            <td class="px-6 py-3 text-gray-600">Penyakit Dalam</td>
                            <td class="px-6 py-3 text-gray-600">Senin, Rabu, Jumat</td>
                            <td class="px-6 py-3 text-gray-600">08.00 – 12.00</td>
                        </tr>
                        <tr class="bg-gray-50/50">
                            <td class="px-6 py-3 font-medium text-gray-900">drg. Siti Nurhaliza</td>
                            <td class="px-6 py-3 text-gray-600">Dokter Gigi</td>
                            <td class="px-6 py-3 text-gray-600">Selasa, Kamis, Sabtu</td>
                            <td class="px-6 py-3 text-gray-600">09.00 – 14.00</td>
                        </tr>
                        <tr>
                            <td class="px-6 py-3 font-medium text-gray-900">dr. Budi Setiawan</td>
                            <td class="px-6 py-3 text-gray-600">Umum</td>
                            <td class="px-6 py-3 text-gray-600">Senin – Sabtu</td>
                            <td class="px-6 py-3 text-gray-600">08.00 – 16.00</td>
                        </tr>
                        <tr class="bg-gray-50/50">
                            <td class="px-6 py-3 font-medium text-gray-900">dr. Maya Anggraini, Sp.A</td>
                            <td class="px-6 py-3 text-gray-600">Anak</td>
                            <td class="px-6 py-3 text-gray-600">Selasa, Kamis</td>
                            <td class="px-6 py-3 text-gray-600">13.00 – 17.00</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <p class="text-xs text-gray-400 mt-3 text-center">* Jadwal dapat berubah sewaktu-waktu. Hubungi kami untuk konfirmasi ketersediaan dokter.</p>
        </div>
    </section>
    ...
    <section class="max-w-6xl mx-auto px-6 py-16">
        <div class="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div class="rounded-xl overflow-hidden shadow-lg border border-gray-100 aspect-video bg-black">
                <iframe class="w-full h-full" src="https://www.youtube.com/embed/Nzi3MF5Yn4k?si=GTt03esOfwkY-cCJ" title="Profil Klinik Sehat" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </section>
    ...
    <section id="kontak" class="max-w-6xl mx-auto px-6 py-16">
        <div class="grid md:grid-cols-2 gap-10">
                ...
                <div class="space-y-5 text-sm">
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500">Jl. Jendral Sudirman No. 45, Kebayoran Baru,<br>Jakarta Selatan 12190</p>
                        </div>
                    </div>
                    <div class="flex gap-3">
                    ...
                    <div class="flex gap-3">
                        <div class="w-9 h-9 bg-amber-50 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg class="w-4 h-4 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                        </div>
                        <div>
            ...
            <div class="rounded-xl overflow-hidden border border-gray-200 shadow-sm">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.2804846839895!2d106.80047431476882!3d-6.225634995494!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f14d6c2f2ba7%3A0x4c7d5e5f7fdae3f8!2sJl.%20Jend.%20Sudirman%2C%20Jakarta!5e0!3m2!1sid!2sid!4v1700000000000" width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
        </div>
    </section>
