...
@section('title', 'Tambah Jadwal Dokter - SI-PEKA')

@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-slate-800">Tambah Jadwal Dokter</h1>
</div>
    ...
    <form action="{{ route('admin.schedules.store') }}" method="POST">
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            <div>
                ...
                <input type="time" name="start_time" value="{{ old('start_time') }}" required class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 px-4 py-2 border">
            ...
            <div>
                ...
                <input type="time" name="end_time" value="{{ old('end_time') }}" required class="w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 px-4 py-2 border">
